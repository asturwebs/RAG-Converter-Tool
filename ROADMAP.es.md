...
Las contribuciones son bienvenidas. Ver [LICENSE](./LICENSE) y [NOTICE.es.md](./NOTICE.es.md) para términos.
...
Si esta herramienta te es útil y la usas en un entorno comercial, se agradece la atribución visible al autor original. Ver [NOTICE.es.md](./NOTICE.es.md).
